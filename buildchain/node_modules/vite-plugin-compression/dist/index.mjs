...
${chalk.cyan("\u2728 [vite-plugin-compression]:algorithm=" + algorithm)} - compressed file successfully: `);
  ...
  compressMap.forEach((value, name) => {
    ...
    config.logger.info(chalk.dim(path2.basename(config.build.outDir) + "/") + chalk.blueBright(rName) + " ".repeat(2 + maxKeyLength - name.length) + " " + chalk.dim(sizeStr));
  });
  config.logger.info("\n");
}
